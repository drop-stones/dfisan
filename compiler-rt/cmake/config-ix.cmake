...
if(APPLE)
  ...
  set(DFISAN_SUPPORTED_ARCH ${SANITIZER_COMMON_SUPPORTED_ARCH})
  ...
  filter_available_targets(DFISAN_SUPPORTED_ARCH ${SANITIZER_COMMON_SUPPORTED_ARCH})
...
set(ALL_SANITIZERS asan;dfsan;msan;hwasan;tsan;safestack;cfi;scudo;ubsan_minimal;gwp_asan;dfisan)
...
if (COMPILER_RT_HAS_SANITIZER_COMMON AND OS_NAME MATCHES "Linux")
  set(COMPILER_RT_HAS_DFISAN TRUE)
else()
  set(COMPILER_RT_HAS_DFISAN FALSE)
endif()
